...
/***/ function(module, exports, __webpack_require__) {
	...
	v_head = new Vue({
	  ...
	  components: {
	    'head_c': __webpack_require__(7),
	    'left_bar_c': __webpack_require__(11),
	    'foot_c': __webpack_require__(13),
	    'welcome': __webpack_require__(15)
	  },
	  events: {
	...
	module.exports = Vue.extend({
	  ...
	  methods: {
	    ...
	    get_bar_data: function() {
	      var parm;
	      parm = JSON.stringify({
	        request_type: "base_business.get_bar_data"
	      });
	      return post_load({
	        parm: parm,
	        url: "common_post_request",
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"ui main text container\" style=\"min-height: 100%\">\n\t<h1 class=\"ui header\">欢迎页</h1>\n\t<p>This is a basic fixed menu template using fixed size containers.</p>\n\t<p>A text container is used for the main container, which is useful for single column layouts</p>\n</div>";
